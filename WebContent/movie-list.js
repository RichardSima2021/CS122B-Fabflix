...
function handleMovieResult(resultData) {
    ...
    for (let i = 0; i < resultData.length-1; i++) {
        ...
        rowHTML += "<td>" +"<button id = \"cart_plus\" type=\"button\" class=\"btn btn-outline-secondary btn-sm cart_plus\" style=\"background-color: #BDCDD6\"> <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"16\" height=\"16\" fill=\"currentColor\" class=\"bi bi-cart-plus\" viewBox=\"0 0 16 16\">\n" +
